...
const WhatsAppButton = forwardRef<HTMLAnchorElement>((_, ref) => {
  const phoneNumber = "917676295599"; // Without + sign for wa.me
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#128C7E] text-white shadow-elevated flex items-center justify-center transition-all duration-300 hover:scale-105 group"
