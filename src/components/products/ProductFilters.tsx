...
const filterSections: FilterSection[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Tope Teni Pallu", value: "Tope Teni Pallu" },
  ...
  },
  {
    ...
    key: "border",
    options: [
      { label: "Contrast Border", value: "Contrast Border" },
      { label: "Temple Border", value: "Temple Border" },
      { label: "Zari Border", value: "Zari Border" },
      { label: "Self Border", value: "Self Border" },
      { label: "Broad Border", value: "Broad Border" },
  ...
  },
  {
    ...
    options: [
      { label: "Tope Teni Pallu", value: "Tope Teni Pallu" },
      { label: "Zari Pallu", value: "Zari Pallu" },
      { label: "Simple Pallu", value: "Simple Pallu" },
      { label: "Heavy Pallu", value: "Heavy Pallu" },
    ],
  },
  {
    title: "Occasion",
    ...
    options: [
      ...
      { label: "Wedding Wear", value: "Wedding Wear" },
      { label: "Traditional Events", value: "Traditional Events" },
  ...
  },
  {
    ...
    key: "blouse",
    options: [
      { label: "Running Blouse", value: "Running Blouse" },
      { label: "Contrast Blouse", value: "Contrast Blouse" },
      { label: "Attached Blouse Piece", value: "Attached Blouse Piece" },
    ],
  },
  {
    title: "Discount",
